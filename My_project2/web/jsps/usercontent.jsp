                    ...
                    <div class = "container">
                        <div class = "missing">
                            <tl class = flight>
                                <c:choose>
                                    <c:when test = "${priority == 'admin'}">
                                        <a href ="/Controller?command=deleteFlight&id=${flight[k].getId()}">
                        ...
                        <div class = "missing">
                            <tl  class = table>
                                <p>
                                    <c:out value="${flight[k].getDate().get(flight_date)}.${flight[k].getDate().get(flight_month)}.${flight[k].getDate().get(flight_year)}"/>
                                </p>
                            </tl>
                        </div>
                        <c:choose>
